...
def save_prediction_vs_gt(args):
    ...
    model_vis_dir = args.model_vis_dir
    ...
    # Automatically infer resolution from video
    pred_h, pred_w = video.shape[1:3]
    print(f"Auto-inferred resolution: ({pred_h}, {pred_w})")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_folder", default="./dataset/tapvid-davis/davis_480/0/video", type=str)
    parser.add_argument("--trajectories_dir", default="output_folder/davis_480/0/dinov2_loftup_grid_trajectory", type=str)
    parser.add_argument("--occlusions_dir", default="output_folder/davis_480/0/dinov2_loftup_grid_occlusion", type=str)
    parser.add_argument("--model_vis_dir", default="./output_folder/davis_480/0/pred_vs_gt_dinov2_loftup", type=str)
    ...
    #parser.add_argument("--infer-res-size", type=int, nargs=2, default=(480, 854), help="Inference resolution size, (h, w). --NOTE-- change according to values in train.yaml.")
