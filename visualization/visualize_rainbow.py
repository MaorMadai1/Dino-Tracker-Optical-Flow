...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", default="./dataset/horsejump", type=str)
    ...
    parser.add_argument("--plot-trails", action="store_true", default=True, help="Plot rainbow trails using homographies.")
