...
class VitExtractor(nn.Module):
    ...
    def _register_hooks(self, **kwargs):
        for block_idx, block in enumerate(self.model.blocks):
            ...
            # maor.madai - disabled this because of the changes in the new dinov2 version
            # if block_idx in self.layers_dict[VitExtractor.ATTN_KEY]:
            #     self.hook_handlers.append(block.attn.proj_drop.register_forward_hook(self._get_attn_hook()))
