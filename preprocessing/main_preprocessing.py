...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="./config/preprocessing.yaml", help="Config path", type=str)
    parser.add_argument("--data-path", default="./dataset/tapvid-davis/davis_480/2", type=str)
